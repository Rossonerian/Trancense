...
export async function getHealthStatus() {
  ...
  if (!client) return { status: "degraded" as const, dataMode: "supabase" as const, dataLabel: "Demo Data", ...base };
  ...
  if (check.error) return { status: "degraded" as const, dataMode: "supabase" as const, dataLabel: "Demo Data", ...base };
