...
export async function getHealthStatus() {
  ...
  if (!client) return { status: "degraded" as const, dataMode: "demo" as const, dataLabel: "Demo Data", reason: "Supabase variables are missing", ...base };
  ...
  if (check.error) return { status: "degraded" as const, dataMode: "demo" as const, dataLabel: "Demo Data", reason: "Supabase connection unavailable", ...base };
